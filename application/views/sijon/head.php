...
<link rel="stylesheet" href="<?php echo base_url('vendor/owlcarousel/owl.carousel.min.css')?>">
<link rel="stylesheet" href="<?php echo base_url('vendor/lightcase/lightcase.css')?>">
